...
#' @export
setMethod("plotFCs", signature = "xtailResults",
  function(object,
           log2FC.cutoff = 1,
           cex=1, xlim,
           ylim, ...,
...
#' @param object a xtailResults
#' @export
setMethod("plotRs", signature = "xtailResults",
  function(object, log2R.cutoff = 1, cex=1, xlim, ylim, ..., cex.lab, cex.axis, cex.main, cex.sub, pch)
  {
    if(is.null(object$resultsTable)) stop("error, the object must be created by using the xtail function.")
    if(!is(object, "xtailResults")) stop("error, the object must be created by using the xtail function.")
...
#' @param object a xtailResults
#' @export
setMethod("volcanoPlot", signature = "xtailResults",
  function(object){
